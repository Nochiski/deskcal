...
- 라이선스: [PolyForm Noncommercial 1.0.0](LICENSE). 개인·연구·교육·비영리 목적의 사용, 수정, 배포는 자유이며 **상업적 사용은 금지**됩니다.
  상업적 이용이 필요하면 저작권자에게 별도 허가를 받아야 합니다.
- 개인정보처리방침: [PRIVACY.md](PRIVACY.md). 앱은 서버 없이 PC에서만 동작하며 어떤 데이터도 수집하지 않습니다.
